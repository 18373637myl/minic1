...
public class Instruction {
    ...
    public Instruction(Operation type){
        this.type = type;
        this.hasNum = false;
        this.needRelocation = false;
    }
    public Instruction(Operation type, boolean is_u32, long num){
        this.type = type;
        this.hasNum = true;
        this.is_d64 = false;
        this.needRelocation = false;
    ...
    public Instruction(Operation type, double num){
        this.needRelocation = false;
        this.type = type;
        this.hasNum = true;
        this.is_u32 = false;
